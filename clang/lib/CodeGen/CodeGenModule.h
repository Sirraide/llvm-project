...
private:
  ...
  llvm::FunctionCallee CXXContractViolationHandler;
...
public:
  ...
  /// Get the C++26 contract violation handler. This is invoked when
  /// a contract violation occurs.
  llvm::FunctionCallee GetOrCreateCXXContractViolationHandler();
